...
export const HERO_SECTION_CLASS =
  "relative flex min-h-0 items-start justify-center overflow-x-clip pt-[9.75rem] pb-10 select-none md:min-h-[var(--hero-min-h)] md:items-center md:pt-24 md:pb-14 lg:pt-59 lg:pb-40";
