      ...
      <div className="mx-auto max-w-[1260px] px-4 sm:px-6">
        <HomeReveal variants={homeScaleIn}>
          ...
          >
            ...
            <h2 className="font-heading relative z-10 mx-auto mb-8 max-w-3xl px-1 text-2xl leading-[1.15] font-bold tracking-tight text-white sm:mb-10 sm:text-3xl md:text-[2.5rem] lg:text-[2.75rem]">
              {cta.title}
            </h2>
